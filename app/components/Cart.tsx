  ...
  return (
    <div className="w-full h-full flex justify-end">
      <motion.div
        ...
        className="mx-4 max-h-[720px] my-5 drop-shadow-md flex flex-col justify-between font-sans w-[380px] bg-white rounded-xl h-[80vh]"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="flex-1 p-4 h-full overflow-x-hidden overflow-y-auto">
            {cart ? (
              cart.map((data: ProductTypes, index: number) => (
                <motion.div
